...
public class Project1 {
	public static void main(String[] args) {
        ...
        for (int i = 1; i <= 10; i++) {
            System.out.println("Question " + i + ": Rs." + (i * 100));
        }
        System.out.println(); 
        ...
        for (int i = 0; i < questions.length; i++) {
            ...
            if (userAnswer == correctAnswers[i]) {
                ...
                score++;
                earnings += (i + 1) * 100;  
                System.out.println("Congratulations! You earned Rs." + ((i + 1) * 100) + ". Your total earnings: Rs." + earnings);
            } else {
        ...
        System.out.println("Your total earnings: Rs." + earnings);
        scanner.close();
    }
}
