...
class Tiger3{
	...
	public Tiger3(String name) {
		this("rocky", "brown");
		this.name = name;
		System.out.println("Hi from single para const");
	}
	public Tiger3(String name, String color) {
		this("jimmy","black", 2);
		this.name = name;
		this.color = color;
		System.out.println("Hi from second para const");
	}
	public Tiger3(String name, String color, int age) {
		this("ABC", "orange", 5, "UK");
		this.name = name;
		this.color = color;
		this.age = age;
		System.out.println("Hi from Three para const");
	}
	public Tiger3(String name, String color, int age, String country) {
		...
		System.out.println("Hi from four para const");
	}
